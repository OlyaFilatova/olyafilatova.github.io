...
export const knowledgeSources: KnowledgeSource[] = [
  {
    ...
    "thoughts": [
      ...
      },
      {
        ...
        "ua": "Пояснює внутрішню роботу та варіанти використання кількох поширених функторів: Identity, Compose, Maybe, Either(Right, Left), IO, Task, Map."
      },
      {
        ...
        "ua": "Показує, як реалізувати потік керування, обробку помилок, асинхронні дії, побічні ефекти за допомогою функціонального підходу. Надає простий приклад веб-сайту, написаного з використанням функціонального підходу: запит та відображення списку зображень."
      },
      {
        ...
        "ua": "Ця книга навчає читача бачити код крізь призму абстрактної алгебри, використовуючи теорію категорій та теорію груп."
      },
      {
        ...
        "ua": "До того як почати читати книгу я очікувала звичайних змін у структурі коду. Але перший розділ познайомив мене з ідеєю про те, що функціональні програми не є \"функціо\" з точки зору термінів коду, а з точки зору термінів математики. Спостерігати за тим, як рішення відмовитися від назв функцій та замінити їх на звичайні операції '+' та '*' дозволило спростити ланцюжок викликів за допомогою правил арифметики, було вкрай захопливо. Але тепер мені цікаво, наскільки стиль коментарів до коду повинен змінитися з цією парадигмою."
      },
      {
        "en": "Into 5th chapter now and feel like the connection to math is not so apparent anymore. ...till the Category Theory section.",
        "ua": "Поки читала 5ий розділ виникло відчуття, що звʼязку з математикою знову не видно. ...поки не почала читати секцію \"Category Theory\"."
      },
      {
      ...
      },
      {
        ...
        "ua": "Функції стають дуже короткими і їх стає доволі багато."
      },
      {
      ...
      },
      {
        ...
        "ua": "Для людини, яка вже досить довго пише в імперативному стилі, при першому прочитанні імперативний стиль все ще набагато читабельніший. Але я розумію, що з усіма допоміжними класами та функціями, попередньо визначеними в бібліотеці, код стає набагато меншим, а для досвідченого у функціональному програмуванні розробника більш читабельним."
      }
    ]
  },
  {
