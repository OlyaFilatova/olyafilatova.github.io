...
export const KnowledgeSourceMeta = zod.object({
...
export const KnowledgeSourceContent = zod.array(localizedString);

export const KnowledgeSource = KnowledgeSourceMeta.extend({
